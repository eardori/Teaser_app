 ...
 * Copyright (c) 2009-2011 by TakeTalks, Inc. All Rights Reserved.
...
//@interface TakeTalksObject : NSObject
//@end

@interface TakeTalksObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TakeTalksObject class]])
		{
			for (NSString *key in [[(TakeTalksObject*)o modules] allKeys])
			{
