...
/**
 Base class for all TakeTalks views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TakeTalks view hierarchy (such as wrapped iOS UIViews) was touched.
