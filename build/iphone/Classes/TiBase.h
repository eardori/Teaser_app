...
// in simulator we redefine to format for TakeTalks Developer console
...
{\
	NSString * exceptionName = [@"org.taketalks." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.taketalks";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITakeTalksNativeItemNone = -1, 
	UITakeTalksNativeItemSpinner = -2,
	UITakeTalksNativeItemProgressBar = -3,
	
	UITakeTalksNativeItemSlider = -4,
	UITakeTalksNativeItemSwitch = -5,
	UITakeTalksNativeItemMultiButton = -6,
	UITakeTalksNativeItemSegmented = -7,
	
	UITakeTalksNativeItemTextView = -8,
	UITakeTalksNativeItemTextField = -9,
	UITakeTalksNativeItemSearchBar = -10,
	
	UITakeTalksNativeItemPicker = -11,
	UITakeTalksNativeItemDatePicker = -12,
	
	UITakeTalksNativeItemInfoLight = -13,
	UITakeTalksNativeItemInfoDark = -14,
	
	UITakeTalksNativeItemDisclosure = -15,
	
	UITakeTalksNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TakeTalks instances of
