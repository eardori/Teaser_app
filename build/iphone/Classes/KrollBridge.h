...
@interface TakeTalksObject : KrollCoverageObject {
#else
@interface TakeTalksObject : KrollObject {
#endif
@private
...
extern NSString * TakeTalks$ModuleRequireFormat;
